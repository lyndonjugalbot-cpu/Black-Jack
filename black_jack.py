...
def calculate_score(cards):
    ...
    # A blackjack (ace + 10 with exactly 2 cards) is represented as 0.
    if sum(cards) == 21 and len(cards) == 2:
        return 0

    # If we're bust but holding an ace, count that ace as 1 instead of 11.
...
# If they answer yes, clear the console and start a new game of blackjack and show the logo from art.
